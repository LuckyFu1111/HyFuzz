...
# Ensure the client test package remains importable after renaming from
# ``tests`` to ``client_tests`` to avoid namespace clashes with the server.
_CLIENT_TESTS = ROOT / "HyFuzz-Ubuntu-Client" / "client_tests"
